...
class UAgentInfo(object):
    ...
    def detectIphone(self):
        ...
        return (
            UAgentInfo.deviceIphone in self.__userAgent
    ...
    def detectS60OssBrowser(self):
        ...
        return self.detectWebkit() and (
            UAgentInfo.deviceSymbian in self.__userAgent
    ...
    def detectWindowsMobile(self):
        ...
        if (
            UAgentInfo.deviceWinMob in self.__userAgent
        ...
        if (
            UAgentInfo.manuHtc in self.__userAgent
            and UAgentInfo.deviceWindows in self.__userAgent
        ):
            return True
        if self.detectWapWml() and UAgentInfo.deviceWindows in self.__userAgent:
            return True

        # Test for Windows Mobile PPC but not old Macintosh PowerPC.
        return (
            UAgentInfo.devicePpc in self.__userAgent
    ...
    def detectBlackBerry(self):
        ...
        """
        return (
            UAgentInfo.deviceBB in self.__userAgent
    ...
    def detectBlackBerryTouch(self):
        ...
        """
        return (
            UAgentInfo.deviceBBStorm in self.__userAgent
    ...
    def detectPalmOS(self):
        ...
        if (
            UAgentInfo.devicePalm in self.__userAgent
    ...
    def detectWebOSTablet(self):
        ...
        """
        return (
            UAgentInfo.deviceWebOShp in self.__userAgent
    ...
    def detectDangerHiptop(self):
        ...
        """
        return (
            UAgentInfo.deviceDanger in self.__userAgent
    ...
    def detectOperaMobile(self):
        ...
        """
        return UAgentInfo.engineOpera in self.__userAgent and (
            UAgentInfo.mini in self.__userAgent or UAgentInfo.mobi in self.__userAgent
        )
    ...
    def detectOperaAndroidPhone(self):
        ...
        """
        return (
            UAgentInfo.engineOpera in self.__userAgent
    ...
    def detectWapWml(self):
        ...
        """
        return (
            UAgentInfo.vndwap in self.__httpAccept
    ...
    def detectMobileQuick(self):
        ...
        if (
            UAgentInfo.engineNetfront in self.__userAgent
        ...
        if (
            UAgentInfo.devicePda in self.__userAgent
        ...
        if self.detectKindle() or self.detectAmazonSilk():
            return True
    ...
    def detectNintendo(self):
        ...
        """
        return (
            UAgentInfo.deviceNintendo in self.__userAgent
    ...
    def detectGameConsole(self):
        ...
        """
        return (
            self.detectSonyPlaystation() or self.detectNintendo() or self.detectXbox()
        )
    ...
    def detectMidpCapable(self):
        ...
        """
        return (
            UAgentInfo.deviceMidp in self.__userAgent
    ...
    def detectMaemoTablet(self):
        ...
        return (
            UAgentInfo.linux in self.__userAgent
            and UAgentInfo.deviceTablet in self.__userAgent
    ...
    def detectSonyMylo(self):
        ...
        """
        return UAgentInfo.manuSony in self.__userAgent and (
            UAgentInfo.qtembedded in self.__userAgent
    ...
    def detectMobileLong(self):
        ...
        return (
            UAgentInfo.uplink in self.__userAgent
    ...
    def detectTierIphone(self):
        ...
        return (
            ...
            and self.detectBlackBerryTouch()
            or self.detectWindowsPhone7()
            or self.detectPalmWebOS()
            or self.detectGarminNuvifone()
        )
